            ...
            <aside className="hidden md:flex w-72 bg-white border-r border-slate-100 flex-col sticky top-0 h-screen z-50">
                <div className="p-10">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-black text-slate-800 uppercase tracking-tighter text-xl italic">Apê 2026</span>
                    </div>
                </div>
                ...
                <div className="p-8 mt-auto border-t border-slate-50">
                    <div className="flex items-center justify-between gap-3 mb-2 px-2">
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            <p className="text-xs font-black text-slate-800 truncate uppercase tracking-widest">{userName?.split(' ')[0]}</p>
                        </div>
                        <button 
                            onClick={logout}
