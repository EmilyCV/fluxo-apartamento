...
const ambientes: Ambiente[] = [
    "1. Cozinha", "2. Sala", "3. Varanda", "4. Banheiro", "5. Escritório", "6. Quarto", "7. Gerais"
];

const categorias: Categoria[] = [
    "1. Reforma", "2. Eletros", "3. Utensílios", "4. Enxoval"
];
...
const prioridades: Prioridade[] = [
    "Comprar agora", "Quando der", "Pode esperar", "Aguardando projeto", "Adquirido"
];
...
export const generateMockItems = (count: number = 20): CompraItem[] => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        const subCategoria = subCategoriasPossiveis[Math.floor(Math.random() * subCategoriasPossiveis.length)];
